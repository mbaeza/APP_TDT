//
//  EjerciciosSemejanzaViewController.swift
//  Creylp
//
...
class EjerciciosSemejanzaViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        let viewController = segue.destinationViewController as! EjercicioAlumnoSemejanzaViewController
