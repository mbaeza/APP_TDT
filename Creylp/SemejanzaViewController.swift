//
//  SemejanzaViewController.swift
//  Creylp
//
//  Created by Marco Baeza on 16-04-15.
//  Copyright (c) 2015 Marco Baeza. All rights reserved.
//

import UIKit

class SemejanzaViewController: UIViewController {
    
    @IBOutlet weak var imagenSegunda: UIImageView!
    @IBOutlet weak var imagenTercera: UIImageView!
    @IBOutlet weak var imagenQuinta: UIImageView!
    @IBOutlet weak var imagenSeptima: UIImageView!
    @IBOutlet weak var imagenOctava: UIImageView!
    @IBOutlet weak var imagenSexta: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        let tapGestureCinco = UITapGestureRecognizer(target: self, action: "tapGestureCinco:")
        let tapGestureSeis = UITapGestureRecognizer(target: self, action: "tapGestureSeis:")
        let tapGestureSiete = UITapGestureRecognizer(target: self, action: "tapGestureSiete:")
        let tapGestureOcho = UITapGestureRecognizer(target: self, action: "tapGestureOcho:")
        ...
        */
        ...
        var url:NSURL = NSURL(string: "http://localhost:8080/APP_TDT_WEB-war/webresources/ServiciosWeb/ObtenerImagenEjerciciosSemejanza/"+idEjercicio)!
                ...
                if(success == "00")
                {
                    ...
                    for( var i = 0;i<imagenes.count;i++ ){
                        ...
                        case 5:
                            ...
                            imagenQuinta.addGestureRecognizer(tapGestureCinco)
                            imagenQuinta.userInteractionEnabled = true
                            if(respuestaCorrecta == true){
                                imagenQuinta.tag = 1
                            }
                        case 6:
                            imagenSexta.hnk_setImageFromURL(imagenURL);
                            imagenSexta.addGestureRecognizer(tapGestureSeis)
                            imagenSexta.userInteractionEnabled = true
                            if(respuestaCorrecta == true){
                                imagenSexta.tag = 1
                            }
                        case 7:
                            imagenSeptima.hnk_setImageFromURL(imagenURL);
                            imagenSeptima.addGestureRecognizer(tapGestureSiete)
                            imagenSeptima.userInteractionEnabled = true
                            if(respuestaCorrecta == true){
                                imagenSeptima.tag = 1
                            }
                        case 8:
                            imagenOctava.hnk_setImageFromURL(imagenURL);
                            imagenOctava.addGestureRecognizer(tapGestureOcho)
                            imagenOctava.userInteractionEnabled = true
                            if(respuestaCorrecta == true){
                                imagenOctava.tag = 1
                            }
                        default:
    ...
    func tapGestureCinco(gesture: UIGestureRecognizer) {
        // if the tapped view is a UIImageView then set it to imageview
        if let imageView = gesture.view as? UIImageView {
    ...
    func tapGestureSeis(gesture: UIGestureRecognizer) {
        // if the tapped view is a UIImageView then set it to imageview
        if let imageView = gesture.view as? UIImageView {
    ...
    func tapGestureSiete(gesture: UIGestureRecognizer) {
        // if the tapped view is a UIImageView then set it to imageview
        if let imageView = gesture.view as? UIImageView {
    ...
    func tapGestureOcho(gesture: UIGestureRecognizer) {
        // if the tapped view is a UIImageView then set it to imageview
        if let imageView = gesture.view as? UIImageView {
