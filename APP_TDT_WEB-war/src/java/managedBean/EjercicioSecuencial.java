...
//        nombresArchivosUpload.add(3,"interrogacion.png");
    ...
    public void generarEjercicio() throws IOException{
            ...
            Secuencia nuevoSecuencia = new Secuencia();
            //nuevoAbsurdo.setColorTexto("#0000");
            nuevoSecuencia.setDescripcionEjercicio(descripcionEjercicio);
            ...
            nuevoSecuencia.setSecuenciaPK(abspk);
