 ...
 *
 */
public class ClienteCS002028_calculoFechaHabilVariable extends GeneralClient {
	...
	private static final String REQUEST_HEADER = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:cal=\"http://osb.bancochile.cl/CalculoFechaHabil/\" xmlns:head=\"http://osb.bancochile.cl/common/HeaderRequest\" xmlns:opc=\"http://osb.bancochile.cl/ESB/CalculoFechaHabil/OpCalculoFechaHabilVariableRequest\">";
	...
	public String callCS002028(FechaContableVO fechaContableVO){
		...
		try {
		  ...
		  respuesta = (String)this.parseResponse(response);
			...
			logger.error("Error, No fue posible invocar el servicio CS002028.CalculoFechaHabilVariable.", e);	
		}
	...
	protected String generaRequest(Object requestVO) {
		...
		bf.append("</head:sucursal></head:transaccion></cal:headerRequest></soapenv:Header><soapenv:Body><cal:CalculoFechaHabilVariable><cuerpo><opc:fechaIngreso>");
		bf.append(fechaContableVO.getFechaActual());
		bf.append("</opc:fechaIngreso><opc:cantidadDias>");
		bf.append(1);
		bf.append("</opc:cantidadDias></cuerpo></cal:CalculoFechaHabilVariable></soapenv:Body></soapenv:Envelope>");
	...
	protected Object parseResponse(SOAPMessage response) {
		...
		try {
			...
			logger.error("Error, No fue posible parsear la respuesta del servicio CS002028.CalculoFechaHabilVariable.", e);	
		}
		return resp;
	}
...
//		ClienteCS002028_calculoFechaHabilVariable test = new ClienteCS002028_calculoFechaHabilVariable();
//		
//		String resp=test.callCS002028("20140814");
